...
- **On the Perception Bottleneck of VLMs for Chart Understanding** (2025) — First author. Co-authors: Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. Published on Arxiv.
...
- **Natural Language Processing**: LLM reasoning, reinforcement learning, truthfulness, interpretability
- **Computer Vision**: Vision-Language Models (VLM), hallucination mitigation
- **Machine Learning**: Parameter-efficient fine-tuning, evaluation suites
